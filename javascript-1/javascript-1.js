...
//CODE HERE
  let phone1 = new Phone('motorola','razor',4,'red',false)
  
  let phone2 = new Phone('Apple','Iphone',100,'white',true)
  
  let phone3 = new Phone('Samsung','what',4344444,'yello',false)
